...
public class AdaptorArtistList extends RecyclerView.Adapter<AdaptorArtistList.MyHolder>
{
    ...
    @NonNull
    @Override
    public AdaptorArtistList.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdaptorArtistList.MyHolder holder, int position)
    {
